...
const App: React.FC = () => {
  ...
  // Se está carregando a sessão, mostra tela de carregamento
  if (isLoadingSession) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="text-center">
            <p className="text-sm font-black text-slate-800 uppercase tracking-widest mb-2">Carregando</p>
            <p className="text-xs text-slate-500 font-medium">Verificando sua sessão...</p>
          </div>
        </div>
      </div>
    );
